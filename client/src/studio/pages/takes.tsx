...
function TakeRow({
  ...
  return (
    <div
      className="flex items-center gap-3 px-4 py-2.5 hover:bg-muted/40 transition-colors border-b border-border/50 last:border-b-0"
...
function SessionGroup({
  ...
  return (
    <div className="ml-4 mb-2" data-testid={`group-session-${sessionId}`}>
      <div className="flex items-center gap-2 py-2 px-3 rounded-md bg-muted/20 hover:bg-muted/40 transition-colors cursor-pointer">
      ...
      {open && (
        <div className="mt-1 ml-2 border-l border-border/60">
          {tracksOpen && (
            <div className="ml-4 mr-2 mt-2 mb-2 rounded-lg border border-border bg-muted/30 p-3">
...
function ProductionGroup({
  ...
  return (
    <div className="mb-3" data-testid={`group-production-${productionId}`}>
      <div className="flex items-center gap-2 py-2.5 px-3 rounded-lg bg-muted/40 hover:bg-muted/60 transition-colors cursor-pointer">
...
function StudioGroup({
  ...
  return (
    <div className="mb-4 rounded-xl border border-border bg-card shadow-sm overflow-hidden" data-testid={`group-studio-${studioId}`}>
      <button
...
const Takes = memo(function Takes({ studioId }: { studioId: string }) {
  ...
  const canManageAudio = hasMinRole("studio_admin");
